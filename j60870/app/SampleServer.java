                    ...
                    switch (aSdu.getTypeIdentification()) {
                        ...
                        case C_IC_NA_1:
                            ...
                            connection.send(new ASdu(ASduType.M_ME_NB_1, true, CauseOfTransmission.INTERROGATED_BY_STATION,
                                    ...
                                    new InformationObject(30001, new InformationElement[][]{
                                            {new IeScaledValue(-32768), new IeQuality(false, false, false, false, false)},
                                            {new IeScaledValue(random.nextInt(100)), new IeQuality(false, false, false, false, false)},
                                            {new IeScaledValue(-5),
